<x-layouts.admin title="Update Ekskul">

<div class="h-full overflow-auto">

    <div class=" rounded-xl ">

       <form action="{{ route('guru-staf.update', $guru_staf->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
             ...
             <div>
                ...
                maxlength="30"
                    type="text"
                    name="jabatan"
                    value="{{ old('jabatan', $guru_staf->jabatan) }}"
                    placeholder="Masukkan Nama Ekskul"
                    class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none
