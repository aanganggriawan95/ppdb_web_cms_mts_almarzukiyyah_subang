<x-layouts.admin title="CMS Fasilitas">
...
<div class="p-6 space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">CMS Fasilitas</h1>
            <p class="text-sm text-gray-500">Kelola fasilitas section website</p>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                @forelse ($fasilitas as $data)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-4">
                            <img 
                                src="{{ asset('storage/fasilitas/'.$data->image) }}" 
                        ...
                        <td class="p-4 text-gray-500 max-w-md">
                            <div class="line-clamp-2">
                                {!! Str::limit(strip_tags($data->deskripsi), 80) !!}
                            </div>
                        </td>
